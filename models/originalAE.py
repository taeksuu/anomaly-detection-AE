...
class OriginalAE(nn.Module):
    # Autoencoder model presented by original code
    # conv2d encoder, conv2d + upsample decoder
    def __init__(self, color_mode, latent_space_dim=128):
        super(OriginalAE, self).__init__()
