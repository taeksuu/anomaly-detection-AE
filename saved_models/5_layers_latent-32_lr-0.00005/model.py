class AutoEncoder(nn.Module):
    def __init__(self, color_mode):
        ...
        self.encoder = nn.Sequential(
            ...
            #Conv9
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=8, stride=1, padding=0)
        )
        
        self.decoder = nn.Sequential(
            #Conv9 reversed
            nn.ConvTranspose2d(in_channels=32, out_channels=32, kernel_size=8, stride=1, padding=0),
            nn.LeakyReLU(0.2),
